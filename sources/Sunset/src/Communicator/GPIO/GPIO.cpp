...
{
    /*
        Номер линии для libgpiod вычисляется по формуле :
            Номер_пина = (Номер_группы * 8) + Номер_в_группе
        Где:
            Номер группы: A=0, B=1, C=2, D=3 и так далее.
            Номер в группе: цифра после буквы группы.
