    ...
    reg(_reg)
{
    ...
    wxSizer *sizer = new wxBoxSizer(wxHORIZONTAL);                  // Здесь будут находиться чекбоксы битов и AnimatedImpulse
...

    {
        ...
        sizer->Add(animation, 1, wxALIGN_CENTER_VERTICAL | wxRIGHT);
    }
